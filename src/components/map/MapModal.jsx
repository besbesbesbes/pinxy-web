...
const MapModal = ({ isOpen, onClose, userPosition, posts }) => {
  ...
  const icons = {
    ...
    SHOP: new L.Icon({
      iconUrl:
        "https://png.pngtree.com/png-vector/20220912/ourmid/pngtree-shop-icon-png-image_6170900.png",
      iconSize: [25, 41],
      iconAnchor: [12, 41],
    }),
    JOB: new L.Icon({
      iconUrl:
        "https://cdn-icons-png.freepik.com/256/14993/14993311.png?semt=ais_hybrid",
      iconSize: [25, 41],
      iconAnchor: [12, 41],
    }),
    OTHER: new L.Icon({
  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      >
        <MapContainer center={userPosition} zoom={19} className="h-full w-full">
          <TileLayer
