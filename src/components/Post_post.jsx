...
function Post_post({ postId }) {
  ...
  return (
    ...
    onMouseEnter={() => {setPostLocation([post.locationLat, post.locationLng]), console.log(postLocation)}}
      onMouseLeave={() => {setPostLocation(userPosition), console.log(postLocation)}}
